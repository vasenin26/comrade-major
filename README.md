...
Асинхронный голосовой ИИ-агент со стримингом аудио. Аудио half-duplex: либо говорит (TTS), либо слушает микрофон — чтобы не триггериться на собственный голос.
